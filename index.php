    ...
    <?php
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            // seccsed
                ...
                $sub="";
                $text="";
                $success = "<div class='ss'> We Have Recieved Your Massege </div>";
            } 
        } 
    ?>
    <div>
    <div class="ss" id="success"> We Have Recieved Your Massege </div>
    <div class="ss" id="error_textarea"> TextArea Must Be Larger Than <strong>10</strong> Letters </div>
    <div class="ss" id="error_user"> Username Must Be Larger Than <strong>3</strong> Letters </div>
    </div>
    <!-- code php -->
